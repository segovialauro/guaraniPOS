...
public interface CashSessionRepository extends JpaRepository<CashSession, Long> {
    ...
    Optional<CashSession> findFirstByCompany_IdAndEstadoOrderByOpenedAtDesc(Long companyId, String estado);//borrar mas adelante
    ...
    Optional<CashSession> findFirstByCompany_IdAndUser_IdAndEstadoOrderByOpenedAtDesc(//elde arriba que se borra por este
            Long companyId,
            Long userId,
            String estado
    );
